...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" id="topfixnav">
        <div class="container">
            ...
            <div class="navbar-collapse collapse" style="margin-top:0px;">
                <ul class="nav navbar-nav navbar-left " id="topnava">
                    ...
                    <li class="nav-item"><a class="active" href="home.html" id="lol"><i class="fa fa-home fa-lg"></i></a></li>
                    <li class="nav-item">
                        <a href="#">Find Blood</a>
                    </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-cart" role="menu">
                            <li>
                                <a href="/profile/<?php echo e($_SESSION['usrname']); ?>" style="color:#808080;">View profile</a>
                            </li>
        ...
        <?php if(isset($_SESSION['usrname']) && isset($_SESSION['verified'])): ?>
            <?php if($_SESSION['verified']==0): ?>
                ...
                <div class="verinotif">
                    ...
                    <center>
                        ...
                        <a href="/resendverif/<?php echo e($_SESSION['usrname']); ?>"><div class="btnverif">Resend verification mail</div></a>
                    </center>
                </div>
    ...
    <div class="container-fluid" id="maincontent">
        ...
        <div class="row" id="hospitaldetails">
            ...
            <div class="col-md-8">
                ...
                <br>
                <p style="margin-left:10%;margin-right:10%;margin-top:10px;font-family: 'Slabo 27px', serif;font-size:1.5em;color:#fffcff">Need money for your treatment? Send us your medical details and and get financial help for your treatment.As the patient, you don't have the time or energy for a difficult process to manage. With Life, you can start a free, easy fundraiser using our wizard in just a few minutes to help with medical bills and cover healthcare costs. Your friends and family want to find a way to show you their support without being a burden all the time and asking what you need. Life's social sharing features will make it easy for you to spread the word to starting bringing in donations right away. (It's fast and easy to link your bank account using wePay too!) Your fundraiser is an easy way to allow your family and friends to make a donation, and you can use features right on the page to keep all your supporters updated with your progress throughout your treatment and recovery. </p>
