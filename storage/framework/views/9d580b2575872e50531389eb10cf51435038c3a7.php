...
<div class="container">
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
            ...
            <a href="http://localhost:8000/username/<?php echo e($username); ?>/verify/<?php echo e($seck); ?>" class="custombutton btncustom" style="width:150px;text-align:center;background-color:orange;display:inline-block;padding:10px;color:white;text-decoration:none;">Verify Now</a>
        </div>
    </div>
</div>
