 ...
 <div class="container">
    <div class="row formsign">
        ...
        <?php endif; ?>
            ...
            <form action="/u/<?php echo e($username); ?>" method="POST" role="form">
            <?php echo e(method_field('PUT')); ?>
                ...
                <div class="form-group">
                    <input type="password" class="form-control" id="" value= "" name="password" placeholder="password" required onkeypress="capLock(event)">
